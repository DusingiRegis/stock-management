...
export function Sidebar({ onCloseMobile }) {
    ...
    return (_jsxs("aside", { className: "w-56 bg-sidebar-light dark:bg-sidebar-dark h-full flex flex-col text-white overflow-y-auto", children: [_jsxs("div", { className: "px-3 py-3 border-b border-gray-700 flex items-center gap-3 flex-shrink-0", children: [_jsx("img", { src: logoSrc, alt: "Stock Management Font Logo", className: "w-12 h-12 rounded-lg object-cover" }), _jsx("h1", { className: "text-base font-bold flex-1 truncate", children: "Stock Font" }), _jsx("button", { onClick: toggleTheme, className: "p-2 rounded-md hover:bg-white/10 transition-colors", title: theme === "light" ? "Dark Mode" : "Light Mode", children: theme === "light" ? _jsx(Moon, { className: "w-4 h-4" }) : _jsx(Sun, { className: "w-4 h-4" }) }), onCloseMobile && (_jsx("button", { onClick: onCloseMobile, className: "p-2 rounded-md hover:bg-white/10 transition-colors md:hidden", children: _jsx(X, { className: "w-4 h-4" }) }))] }), _jsx("nav", { className: "flex-1 px-2 py-2 space-y-0.5", children: visibleMenuItems.map((item) => {
